...
export default class TrumplangListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by TrumplangParser#arrayAssignment.
	enterArrayAssignment(ctx) {
	}

	// Exit a parse tree produced by TrumplangParser#arrayAssignment.
	exitArrayAssignment(ctx) {
	}
	...
	// Enter a parse tree produced by TrumplangParser#twoWeeksStatement.
	enterTwoWeeksStatement(ctx) {
	}

	// Exit a parse tree produced by TrumplangParser#twoWeeksStatement.
	exitTwoWeeksStatement(ctx) {
	}


	// Enter a parse tree produced by TrumplangParser#bankruptcyStatement.
	enterBankruptcyStatement(ctx) {
	}

	// Exit a parse tree produced by TrumplangParser#bankruptcyStatement.
	exitBankruptcyStatement(ctx) {
	}


	// Enter a parse tree produced by TrumplangParser#stopCountStatement.
	enterStopCountStatement(ctx) {
	}

	// Exit a parse tree produced by TrumplangParser#stopCountStatement.
	exitStopCountStatement(ctx) {
	}
	...
	// Exit a parse tree produced by TrumplangParser#tariffStatement.
	exitTariffStatement(ctx) {
	}
