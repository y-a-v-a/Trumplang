...
var literalNames = [ null, "'MAKE AMERICA GREAT AGAIN'", "'I HAVE THE BEST'", 
                     "'I HAVE A VERY GOOD BRAIN FOR'", "'INCREDIBLE'", "'PEOPLE TELL ME'", 
                     ...
                     "'TO'", "'BILLIONS AND BILLIONS'", "'YET'", "'I WILL VETO!'", 
                     "'BUILD THE WALL'", "'AND MEXICO WILL PAY FOR IT'", 
                     "'PREVAILS'", "'EVERYONE IS TALKING ABOUT'", "'MANY PEOPLE ARE ASKING'", 
                     "'MAKE'", "'GREATER'", "'SMALLER'", "'('", "')'", "'SECTION'", 
                     "'FOLLOW'", "'FACT CHECK'", "'I KNOW THE BEST PEOPLE FROM'", 
                     "'I ONLY WANT'", "'SO TRUE'", "'TOTAL DISASTER'", "'BETTER THAN'", 
                     "'AT LEAST AS GOOD AS'", "'NOT AS GOOD AS'", "'NO BETTER THAN'", 
                     "'WRONG'", "'AND IT'S TRUE'", "'OR MAYBE'", "'WINNING'", 
                     "'LOSING'", "'ABSOLUTELY'", "'ENDORSING'", "'SAD'", 
                     "'BIG LEAGUE TIMES'", "'HUGE'", "'BIGLY'", "'SUPPORT'", 
                     "'TWEET'", "'WALL'", "'DEAL'", "'BELIEVE ME'", "'YOU'RE FIRED'", 
...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, null, null, "EQUALS", 
                      "NOT_EQUALS", "GREATER_THAN", "GREATER_THAN_OR_EQUALS", 
                      "LESS_THAN", "LESS_THAN_OR_EQUALS", "NOT", "AND", 
                      "OR", "PLUS", "MINUS", "ASSIGNMENT", "STRING_CONCAT", 
                      "DIVIDE", "MULTIPLY", "INTEGER_TYPE", "FLOAT_TYPE", 
...
TrumplangParser.EQUALS = 35;
TrumplangParser.NOT_EQUALS = 36;
TrumplangParser.GREATER_THAN = 37;
TrumplangParser.GREATER_THAN_OR_EQUALS = 38;
TrumplangParser.LESS_THAN = 39;
TrumplangParser.LESS_THAN_OR_EQUALS = 40;
TrumplangParser.NOT = 41;
TrumplangParser.AND = 42;
TrumplangParser.OR = 43;
TrumplangParser.PLUS = 44;
TrumplangParser.MINUS = 45;
TrumplangParser.ASSIGNMENT = 46;
TrumplangParser.STRING_CONCAT = 47;
TrumplangParser.DIVIDE = 48;
TrumplangParser.MULTIPLY = 49;
...
TrumplangParser.AMPERSAND = 58;
TrumplangParser.DEAL_DECLARE = 59;
TrumplangParser.VAR_DECLARE = 60;
TrumplangParser.VARIABLE = 61;
TrumplangParser.IDENTIFIER = 62;
TrumplangParser.STRING = 63;
TrumplangParser.NUMBER = 64;
TrumplangParser.BOOLEAN = 65;
TrumplangParser.TRUE = 66;
TrumplangParser.FALSE = 67;
TrumplangParser.COMMENT = 68;
TrumplangParser.FILEPATH = 69;
TrumplangParser.WS = 70;
...
ProgramContext.prototype.OPEN_BLOCK = function() {
...
TrumplangParser.prototype.program = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << TrumplangParser.T__1) | (1 << TrumplangParser.T__2) | (1 << TrumplangParser.T__3) | (1 << TrumplangParser.T__6) | (1 << TrumplangParser.T__7) | (1 << TrumplangParser.T__8) | (1 << TrumplangParser.T__11) | (1 << TrumplangParser.T__12) | (1 << TrumplangParser.T__16) | (1 << TrumplangParser.T__18) | (1 << TrumplangParser.T__19) | (1 << TrumplangParser.T__22) | (1 << TrumplangParser.T__23) | (1 << TrumplangParser.T__24))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (TrumplangParser.T__31 - 32)) | (1 << (TrumplangParser.T__32 - 32)) | (1 << (TrumplangParser.T__33 - 32)) | (1 << (TrumplangParser.OPEN_BLOCK - 32)) | (1 << (TrumplangParser.VARIABLE - 32)))) !== 0) || _la===TrumplangParser.COMMENT);
        this.state = 82;
...
TrumplangParser.prototype.dataType = function() {
    ...
    try {
        ...
        this.state = 123;
        _la = this._input.LA(1);
        if(!(((((_la - 50)) & ~0x1f) == 0 && ((1 << (_la - 50)) & ((1 << (TrumplangParser.INTEGER_TYPE - 50)) | (1 << (TrumplangParser.FLOAT_TYPE - 50)) | (1 << (TrumplangParser.BOOLEAN_TYPE - 50)) | (1 << (TrumplangParser.STRING_TYPE - 50)) | (1 << (TrumplangParser.ARRAY_TYPE - 50)) | (1 << (TrumplangParser.STRUCTUR_TYPE - 50)))) !== 0))) {
...
TrumplangParser.prototype.parameterList = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===TrumplangParser.T__5) {
            this.state = 144;
...
TrumplangParser.prototype.returnStatement = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 153;
        this.match(TrumplangParser.T__6);
        this.state = 154;
        this.expression(0);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
TrumplangParser.prototype.functionCall = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 156;
        this.match(TrumplangParser.T__7);
        this.state = 157;
        this.match(TrumplangParser.IDENTIFIER);
        this.state = 158;
        this.match(TrumplangParser.T__4);
...
TrumplangParser.prototype.ifStatement = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 170;
        this.match(TrumplangParser.T__8);
        this.state = 171;
        this.condition(0);
        this.state = 172;
        this.statement();
...
TrumplangParser.prototype.elseIfStatement = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 182;
        this.match(TrumplangParser.T__9);
        this.state = 183;
        this.condition(0);
        this.state = 184;
        this.statement();
...
TrumplangParser.prototype.elseStatement = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 186;
        this.match(TrumplangParser.T__10);
        this.state = 187;
        this.statement();
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
TrumplangParser.prototype.arrayElements = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===TrumplangParser.T__21) {
            this.state = 217;
...
TrumplangParser.prototype.comparison = function() {
    ...
    try {
        ...
        this.state = 264;
        _la = this._input.LA(1);
        if(!(((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (TrumplangParser.EQUALS - 35)) | (1 << (TrumplangParser.NOT_EQUALS - 35)) | (1 << (TrumplangParser.GREATER_THAN - 35)) | (1 << (TrumplangParser.GREATER_THAN_OR_EQUALS - 35)) | (1 << (TrumplangParser.LESS_THAN - 35)) | (1 << (TrumplangParser.LESS_THAN_OR_EQUALS - 35)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
